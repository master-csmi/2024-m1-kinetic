...
Several technical challenges are currently 
impeding the efficient realization of the project:
...
using the Kinetic algorithm, thereby facilitating finite element calculations in diverse contexts.\newline
